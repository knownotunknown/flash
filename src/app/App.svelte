<script>
  ...
  let Flash;
  import('./Flash.svelte').then(module => Flash = module.default);
...
<div class="flex flex-col lg:flex-row flex-wrap">
  <main class="p-12 md:p-16 lg:p-20 xl:p-24 w-screen max-w-none lg:max-w-prose lg:w-auto h-auto lg:h-screen lg:overflow-y-auto prose dark:prose-invert prose-green bg-white dark:bg-gray-900">
    ...
    <section>
      ...
      <ul>
        <li>
          A web browser that supports WebUSB (such as Google Chrome, Microsoft Edge, Opera), running on Windows, macOS, Linux, or Android.
        </li>
      ...
      <ol>
        ...
        <li>
          Fill in three fields. The first field is a description, so you can fill in anything. The next two fields are important. Fill them in with <code>05C6</code> and <code>9008</code> respectively. Press "Install Driver" and give it a few minutes to install.
    ...
    <section>
      ...
      <ol>
        ...
        <li>The device should then be visible as an option when choosing the device to flash.</li>
      </ol>
      <img src={fastbootPorts} alt="image showing comma three and two ports. the upper port is labeled 1. the lower port is labeled 2." width="450" height="300" />
    </section>
    <hr />
    ...
    <section>
      <h2>Flashing</h2>
      <p>
        After your device is in QDL mode, you can click the button to start flashing. A prompt may appear to select a device; choose the device that starts with <code>QUSB_BULK</code>.
      </p>
      <p>
    ...
    <section>
      ...
      <h3>Too slow</h3>
      <p>
        It is recommended that you use a USB 3.0 cable when flashing, as it will speed up the flashing time significantly.
      </p>
